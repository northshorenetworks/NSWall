<?php include('header.php'); ?>
		<div id="sub-nav"><div class="page-title">
			<h1>Multiple Layout Options</h1>
			<span><a href="#" title="Layout Options">Layout Options</a> > <a href="#" title="Three column layout">Three column layout</a> > This is a breadcrumb example</span>
		</div>
<?php include('top_buttons.php'); ?></div>
		<div id="page-layout"><div id="page-content">
			<div id="page-content-wrapper">
				...
				<div class="three-column sortable">
					<div class="three-col-mid">
						...
						<div class="column col3">
							...
							<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
								<div class="portlet-header ui-widget-header">Images<span class="ui-icon ui-icon-circle-arrow-s"></span></div>
								<div class="portlet-content">
									<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</p>
									<p> Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.</p>
									<p> Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo.</p>
				...
				<div class="inner-page-title">
					<h2>Three columns layout</h2>
					<span>In this example example will show you a sortable portlets example</span>
				</div>
				<div class="three-column same-width-col sortable">
					<div class="three-col-mid">
						<div class="column col1">
							<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
								<div class="portlet-header ui-widget-header">Feeds<span class="ui-icon ui-icon-circle-arrow-s"></span></div>
				...
				<div class="clear"></div>
				<div class="inner-page-title">
					<h2>Three columns with content box</h2>
				...
				<div class="clear"></div>
				<div class="inner-page-title">
					<h2>Content boxes placed in columns</h2>
					<span>Lorem ipsum dolor sit amet, consectetuer adipiscing elit</span>
				</div>
				<div class="three-column same-width-col content-box-col">
					<div class="three-col-mid">
						<div class="column col1">
							<div class="content-box">
								<h2>Content Box Title Example (with H2 tag)</h2>
								<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</p>
								<p> Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.</p>
								<p> Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo.</p>
								<p> Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus.</p>
						...
						<div class="column col3">
							<div class="content-box">
								<h4>Content Box Title Example 3 (with H4 tag)</h4>
								<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</p>
								<p> Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.</p>
								<p> Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo.</p>
								<p> Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus.</p>
				...
				<div class="clear"></div>
				<div class="inner-page-title">
					<h2>Two big, one small layout</h2>
					<span>Lorem ipsum dolor sit amet, consectetuer adipiscing elit</span>
				</div>
