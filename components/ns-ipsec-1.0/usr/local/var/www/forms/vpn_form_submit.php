   ...
   switch($form) {
      ...
      case "vpn_ipsec_gw":
         if ($_POST) {
            ...
            if ($_POST['authentication_type'] == "auto") {
               $reqdfields = explode(" ", "srclist myaddress remotegw p1pskey p2ealgo p2halgo name");
               $reqdfieldsn = explode(",", "Routing Policies,Identifier,Remote gw,Pre-Shared Key,P2 Encryption Algorithms,P2 Hash Algorithms, Name");
            }
            else {
