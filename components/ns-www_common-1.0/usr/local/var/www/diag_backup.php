...
<form action="forms/diagnostics_form_submit.php" method="post"
	...
	value="diagnostic_backuprestore">
<fieldset><legend><?=join(": ", $pgtitle);?></legend>
<div><label for="backup">Backup Configuration</label> <input
	name="Submit" type="submit" class="formbtn" id="backup"
	value="Download configuration">
<p class="note">Click this button to download the system configuration
in XML format.</p>
</div>
<div><label for="restore">Restore Configuration</label> <input
	name="conffile" type="file" class="formfld" id="conffile" size="40"><br>
<input name="Submit" type="submit" class="formbtn" id="restore"
	value="Restore configuration">
<p class="note">Open a NSWall configuration XML file and click the
button below to restore the configuration.</p>
</div>
</fieldset>
</form>
</div>
