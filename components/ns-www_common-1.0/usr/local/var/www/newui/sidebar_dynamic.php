		<div id="sidebar">
			<div class="sidebar-content">
				...
				<div class="hide_sidebar">
					...
					<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
						<div class="portlet-header ui-widget-header">Sidebar position</div>
						<div class="portlet-content">
							<ul class="side-menu sidebar-position">
								<li>
									Where would you like to see the sidebar ?<br /><br />
								</li>
								<li>
									<a href="javascript:void(0);" id="sidebar-left" title="Switch to 100% width layout">On the <b>left side</b></a>
								</li>
								<li>
									<a href="javascript:void(0);" id="sidebar-right" title="Switch to 90% width layout">On the <b>right side</b></a>
								</li>
							</ul>
						</div>
					</div>
