...
#casortable li span.col1 {
	position: relative;
	float: left;
	width: 10%;
}

#casortable li span.col2 {
	position: relative;
	float: left;
	width: 5%;
}

#casortable li span.col3 {
	position: relative;
	float: left;
	width: 5%;
}

#casortable li span.col4 {
	position: relative;
	float: left;
	width: 5%;
}

#casortable li span.col5 {
	position: relative;
	float: left;
	width: 15%;
}

#casortable li span.col6 {
	position: relative;
	float: left;
	width: 60%;
}
...
<ul id="casortable">
	...
	$i++;
	endforeach;
	?> <span class="col4"> <?=$internal;?> </span> <span class="col5"> <?=$certcount;?>
	</span> <?php
