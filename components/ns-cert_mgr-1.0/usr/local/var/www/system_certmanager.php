...
// When a user clicks on the cert edit button, load firewall_rules_edittabs.php?id=$id
...
// When a user clicks on the cert delete button: 
...
<ul id="certsortable">
   <li id="element_<?=$i;?>" class="connectedSortable ui-state-disabled"
      style="height: 18px;">
                ...
                <span class="col3">Export</span>
                <span class="col4">Delete</span> 
                <span class="col5">Update CSR</span>
                <span class="col6">CA</span>
                <span class="col7">Common Name</span></li>
      <?php $nrules = 0; for ($i = 0; isset($a_cert[$i]); $i++):
      $certent = $a_cert[$i];
      ?>
   <li id="listItem_<?=$i;?>">
        <span class="col1"><?php echo $certent['name'];?></span>
   <span class="col2"> <?php    if ($certent['crt']): ?> <a
      href="system_certmanager_edit.php?act=exp_cert&id=<?=$i;?>"> <span
      title="export this certifcate" class="ui-icon ui-icon-circle-arrow-s"></span>
   </a> <?php else: ?> * <?php endif; ?> </span>
        <span class="col3"> <?php    if ($certent['prv']): ?> <a
      href="system_certmanager_edit.php?act=exp_pkey&id=<?=$i;?>"> <span
      title="export this private key" class="ui-icon ui-icon-circle-arrow-s"></span>
   </a> <?php else: ?> * <?php endif; ?> </span> 
        <span class="col4"> <a href="id=<?=$i;?>&formname=system_cert_delete"> <span
      title="delete this cert" class="ui-icon ui-icon-circle-close"></span>
   </a> </span>
        <span class="col5"> <?php    if ($certent['csr']): ?> <a
   ...
   ?> 
        ...
        <span class="col6"><?php    if ($ca): ?> <?=$caname;?> <?php else: ?> * <?php endif; ?></span> <?php
   list($CN, $email, $org, $city, $state, $country, $extra) =
   split(",", htmlspecialchars(cert_get_subject($certent['crt'])));
   ?> 

        <span class="col7"><?php if (isset($certent['crt'])) echo "$CN,<br> $email,<br> $org,<br> $city,<br> $state,<br> $country<br>";?></span>
   </li>
   <?php $nrules++; endfor; ?>
</ul>
<div id="newcert">
