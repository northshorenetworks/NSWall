...
<?php $nrules = 0; for ($i = 0; isset($a_group[$i]); $i++):
$aliasent = $a_group[$i]; ?>
<li id="listItem_<?=$i;?>">
<span class="col1">
<a href="services_bgp_groups_edit.php?id=<?=$i;?>">
<span title="edit this rule" class="ui-icon ui-icon-circle-zoomin"></span>
</a>
</span>
<span class="col2">
<a href="forms/services_form_submit.php?id=<?=$i;?>&action=delete&type=group">
<span title="delete this group" class="ui-icon ui-icon-circle-close"></span>
</a>
</span>
...
<div id="newrule"><center><a href="services_bgp_groups_edit.php"><span title="add a new alias" class="ui-icon ui-icon-circle-plus"></span></a></center></div>
</div>
