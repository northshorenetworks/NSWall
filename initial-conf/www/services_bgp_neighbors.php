...
<li id="listItem_<?=$i;?>">
<span class="col1">
<a href="services_bgp_neighbors_edit.php?id=<?=$i;?>">
...
<div id="newrule"><center><a href="services_bgp_neighbors_edit.php"><span title="add a new alias" class="ui-icon ui-icon-circle-plus"></span></a></center></div>
</div>
