...
<div id="wrapper">
	...
	<fieldset>
		<legend><?=join(": ", $pgtitle);?></legend>
			...
			<div>
                 <label for=="multiwansupport">Enable MultiWAN Support</label>
                 <input id="multiwansupport" type="checkbox" name="multiwansupport" value="Yes" <?php if ($pconfig['multiwansupport']) echo "checked"; ?> />
