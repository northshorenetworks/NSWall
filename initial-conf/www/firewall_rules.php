...
<ul id="<?=$if . 'sortable';?>">
	...
	<span class="col1">Order</span> <span class="col2">Edit</span> <span
		...
		class="col5">Name</span> <span class="col6">Description</span></li>
	...
	</a> </span> <span class="col4"><?php if (isset($filterent['name'])) echo strtoupper($filterent['interface']); else echo "*"; ?><?=$textse;?></span>
