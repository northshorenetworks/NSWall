...
<style type="text/css">
    #capturesortable { list-style-type: none; margin: auto auto 1em; padding: 0; width: 95%; }
    #capturesortable li { padding: 0.1em; margin-left: 0; padding-left: 1; font-size: 1.4em; height: 18px; border:1px solid #E4E4E4;  font-size:1em; }
    #capturesortable li span.col1 { position:relative; float:left; width:10em; }
    #capturesortable li span.col2 { position:relative; float:left; width:7em; }
    #capturesortable li span.col3 { position:relative; float:left; width:7em; }
    #capturesortable li span.col4 { position:relative; float:left; width:10em; }
</style>
...
<div class="form-container ui-tabs ui-widget ui-corner-content">
	     ...
	     <input name="formname" type="hidden" value="diagnostic_tcpdump">
