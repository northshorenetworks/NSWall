    ...
    <fieldset>
        ...
        <div>
                ...
                <div>
                   ...
                   <input name="tag" type="text" class="formfld_req" id="tag" size="20" value="<?=htmlspecialchars($pconfig['tag']);?>">
                 ...
                 <div>
                  ...
                  <div id ='connectiontype'>
                             ...
                             <select name="wantype" class="formfld_req" id="wantype">
            ...
            <div id='ipdiv'>
                             ...
                             <input name="ipaddr" type="text" class="formfld_req" id="ipaddr" size="20" value="<?=htmlspecialchars($pconfig['ipaddr']);?>">
                    /
            ...
            <div id='gatewaydiv'>
                             ...
                             <input name="gateway" type="text" class="formfld_req" id="gateway" size="20" value="<?=htmlspecialchars($pconfig['gateway']);?>">
            </div>
            <div id='aliasdiv'>
        ...
        <?php for ($i = 0; $i<sizeof($pconfig['aliaslist']); $i++): ?>
            ...
            <div>
                ...
                <p class="note">Choose which route table this vlan will use</p>
                  ...
                  <div>
                             <label for="dyndnsenable">Enable DNS forwarder</label>
                             <input id="dyndnsenable" type="checkbox" name="dyndnsenable" value="Yes" <?php if ($pconfig['dyndnsenable']) echo "checked"; ?> />
                             <p class="note">Enable DNS forwarder on <?=htmlspecialchars($pconfig['descr']);?> interface.</p>
                  </div>
                  <div>
                        ...
                        <div>
                             ...
                             <input name="range_from" type="text" class="formfld_req" id="range_from" size="20" value="<?=htmlspecialchars($pconfig['range_from']);?>"> to <input name="range_to" type="text" class="formfld_req" id="range_to" size="20" value="<?=htmlspecialchars($pconfig['range_to']);?>">
                             <p class="note">Define the address range for the DHCP server.</p>
            </div>
                        <div>
                             <label for="dhcpdgateway">Gateway</label>
                             <input name="dhcpdgateway" type="text" class="formfld" id="dhcpdgateway" size="20" value="<?=htmlspecialchars($pconfig['dhcpdgateway']);?>">
