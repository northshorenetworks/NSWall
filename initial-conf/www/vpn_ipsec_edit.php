...
Key</label> <input name="p1pskey" type="text" class="formfld"
	id="p1pskey" size="16"
	value="<?=htmlspecialchars($pconfig['p1pskey']);?>"></div>
</fieldset>
...
<div><label for="p2ealgos">Encryption</label> <select name="p2ealgos"
	class="formfld">
	<?php foreach ($p2_ealgos as $algo => $algoname): ?>
	<option value="<?=$algo;?>"
	<?php if (in_array($algo, $pconfig['p2ealgos'])) echo "checked"; ?>><?=htmlspecialchars($algoname);?>
	</option>
	<?php endforeach; ?>
</select>
...
<div><label for="p2halgos">Hash</label> <select name="p2halgos"
	class="formfld">
	<?php foreach ($p2_halgos as $algo => $algoname): ?>
	<option value="<?=$algo;?>"
	<?php if (in_array($algo, $pconfig['p2halgos'])) echo "checked"; ?>><?=htmlspecialchars($algoname);?>
	</option>
	<?php endforeach; ?>
</select>
