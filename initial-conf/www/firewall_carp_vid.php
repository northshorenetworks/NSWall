...
$(".col2 a").click(function () {
        if (confirm('Are you sure you want to delete this CARP interface?')){  
...
<ul id="aliassortable">
	...
	<li id="listItem_<?=$i;?>"><span class="col1"> <a
		href="firewall_carp_vid_edit.php?id=<?=$i;?>"> <span
		title="edit this rule" class="ui-icon ui-icon-circle-zoomin"></span> </a>
	</span> <span class="col2"> <a
		href="forms/interfaces_form_submit.php?id=<?=$i;?>&action=delete&type=vid">
	<span title="delete this Virtual IP"
		class="ui-icon ui-icon-circle-close"></span> </a> </span> <span
		class="col3"><?php if (isset($aliasent['name'])) echo strtoupper($aliasent['name']); else echo "*"; ?><?=$textse;?></span>
	<span class="col4"><?php if (isset($aliasent['descr'])) echo $aliasent['descr'];?></span>
	</li>
	<?php $nrules++; endfor; ?>
</ul>
<div id="newrule">
<center><a href="firewall_carp_vid_edit.php"><span
