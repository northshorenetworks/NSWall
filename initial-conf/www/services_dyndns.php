...
<div id="wrapper">
	...
	<form action="forms/services_form_submit.php" method="post" name="iform" id="iform">
        <input name="formname" type="hidden" value="service_dyndns">
		<input name="id" type="hidden" value="<?=$id;?>">
	<fieldset>
		<legend><?=join(": ", $pgtitle);?></legend>
			<div>
                             <label for="enable">Enable Dyndns</label>
			...
			<div>
                             ...
                             <input id="host" type="text" name="host" value="<?=htmlspecialchars($pconfig['host']);?>" />
            </div>
			<div>
                             <label for="server">Server</label>
                             <input id="server" type="text" name="server" value="<?=htmlspecialchars($pconfig['server']);?>" />
                             <p class="note">Special server to connect to. This can usually be left blank.</p>
            </div>
			<div>
                             <label for="port">Port</label>
                             <input id="port" type="text" name="port" value="<?=htmlspecialchars($pconfig['port']);?>" />
                             <p class="note">Special server port to connect to. This can usually be left blank.</p>
            </div>
			<div>
                             <label for="mx">MX</label>
                             <input id="mx" type="text" name="mx" value="<?=htmlspecialchars($pconfig['mx']);?>" />
                             <p class="note">Set this option only if you need a special MX record. Not all services support this.</p>
            </div>
			<div>
                             <label for="wildcard">Wildcards</label>
			...
			<div>
                             ...
                             <input id="username" type="text" name="username" value="<?=htmlspecialchars($pconfig['username']);?>" />
            </div>
			<div>
                             <label for="password">Password</label>
                             <input id="password" type="password" name="password" value="<?=htmlspecialchars($pconfig['password']);?>" />
            </div>
	</fieldset>
