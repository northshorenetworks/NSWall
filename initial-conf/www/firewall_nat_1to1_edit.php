...
<form action="forms/firewall_form_submit.php" method="post" name="iform"
	...
	value="firewall_nat_1to1"> <input name="id" type="hidden"
	value="<?=$id;?>">
...
<div><label for="internal">Internal IP</label> <input name="internal"
	type="text" class="formfld" id="internal" size="20"
	value="<?=htmlspecialchars($pconfig['internal']);?>" />
<p class="note">Enter the internal ip address for the 1 to 1 mapping.</p>
</div>
<div><label for="external">External IP</label> <input name="external"
	type="text" class="formfld" id="external" size="20"
	value="<?=htmlspecialchars($pconfig['external']);?>" />
