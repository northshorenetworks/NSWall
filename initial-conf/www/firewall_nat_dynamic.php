...
#dnatsortable li span.col1 {
	position: relative;
	float: left;
	width: 4.5%;
}

#dnatsortable li span.col2 {
	position: relative;
	float: left;
	width: 5.5%;
}

#dnatsortable li span.col3 {
	position: relative;
	float: left;
	width: 5.5%;
}

#dnatsortable li span.col4 {
	position: relative;
	float: left;
	width: 7.5%;
}

#dnatsortable li span.col5 {
	position: relative;
	float: left;
	width: 10.5%;
}

#dnatsortable li span.col6 {
	position: relative;
	float: left;
	width: 58%;
}
...
<ul id="dnatsortable">
	...
	<li id="listItem_<?=$i;?>"><span class="col1"><span
		...
		class="col2"> <a href="firewall_nat_dynamic_edit.php?id=<?=$i;?>"> <span
		title="edit this nat rule" class="ui-icon ui-icon-circle-zoomin"></span>
	</a> </span> <span class="col3"> <a
		href="forms/firewall_form_submit.php?id=<?=$i;?>&action=delete&type=dnat">
...
<div id="newrule">
<center><a href="firewall_nat_dynamic_edit.php"><span
	title="add a new rule" class="ui-icon ui-icon-circle-plus"></span></a></center>
</div>
<div id="dnatsaveneworder">
