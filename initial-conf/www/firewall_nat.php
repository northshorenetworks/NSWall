...
<style type="text/css">
    ...
    <?= $ifsortable; ?> li { padding: 0.1em; margin-left: 0; padding-left: 1em; font-size: 1.4em; height: 18px; border:1px solid #E4E4E4;  font-size:1em; }
	...
	<?= $ifsortable; ?> li span.col5 { position:relative; float:left; width:10em; }
...
<span class="col4"><?php if (isset($filterent['interface'])) echo strtoupper($filterent['interface']); else echo "*"; ?><?=$textse;?></span>
